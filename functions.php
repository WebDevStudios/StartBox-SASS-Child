...
class StartBox_Child extends StartBox {

	public function __construct() {
		parent::init();

		// Enqueue our sites Scripts and Styles
		add_action( 'wp_enqueue_scripts', array( $this, 'scripts_and_styles' ), 15 );
	}

	function scripts_and_styles() {
		// we'll import these via SASS
